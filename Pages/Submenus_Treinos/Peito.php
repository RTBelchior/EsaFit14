...
$page_title = "EsaFit 24 - Treino de Peito";

// Definir estilos adicionais específicos desta página
$additional_styles = '
   /* Estilos específicos para a página de peito */
   .muscle-card {
     border-radius: 1rem;
     overflow: hidden;
...
<main>
  ...
  <section class="relative h-[40vh] overflow-hidden" style="background: url('/api/placeholder/1600/600') no-repeat center center; background-size: cover;">
     ...
     <div class="absolute inset-0 flex flex-col justify-center items-start p-6 md:p-16 text-white container mx-auto">
      <h1 class="text-5xl md:text-6xl font-bold mb-4 header-font">
       TREINO <span class="text-orange-500">PEITO</span>
      </h1>
      <p class="text-lg md:text-xl max-w-lg mb-8 text-gray-200">
       Fortaleçe e define os teus músculos peitorais com exercícios específicos para esta região.
      </p>
     </div>
  </section>
  ...
  <section class="py-16 px-6 md:px-16 bg-white">
    <div class="container mx-auto">
      <h2 class="text-4xl font-bold mb-12 text-center header-font">GRUPOS <span class="text-orange-500">MUSCULARES</span> DO PEITO</h2>
      
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-8">
        <!-- Músculo 1 -->
        <div class="muscle-card bg-white border border-gray-100 flex flex-col">
          <div class="h-48 overflow-hidden">
            <img src="https://karoldeliberato.com.br/wp-content/webp-express/webp-images/uploads/2023/04/peitoral-superior.jpg.webp" alt="Peitoral superior" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110"/>
          </div>
          <div class="p-5">
            <h3 class="text-xl font-bold mb-2 header-font text-gray-800">PEITORAL SUPERIOR</h3>
            <p class="text-gray-600 text-base">Parte superior do músculo peitoral maior, responsável por movimentos de flexão do ombro com elevação.</p>
          </div>
        </div>
        ...
        <div class="muscle-card bg-white border border-gray-100 flex flex-col">
          <div class="h-48 overflow-hidden">
            <img src="https://karoldeliberato.com.br/wp-content/uploads/2023/04/peitoral-medial.jpg" alt="Peitoral médio" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110"/>
          </div>
          <div class="p-5">
            <h3 class="text-xl font-bold mb-2 header-font text-gray-800">PEITORAL MÉDIO</h3>
            <p class="text-gray-600 text-base">Região central do músculo peitoral maior, responsável por movimentos de adução horizontal do braço.</p>
          </div>
        </div>
        ...
        <div class="muscle-card bg-white border border-gray-100 flex flex-col">
          <div class="h-48 overflow-hidden">
            <img src="https://karoldeliberato.com.br/wp-content/uploads/2023/04/peitoral-inferior.jpg" alt="Peitoral inferior" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110"/>
          </div>
          <div class="p-5">
            <h3 class="text-xl font-bold mb-2 header-font text-gray-800">PEITORAL INFERIOR</h3>
            <p class="text-gray-600 text-base">Parte inferior do músculo peitoral maior, ativada principalmente em movimentos de adução com depressão.</p>
          </div>
        </div>
      </div>
      
      <div class="text-center mt-16">
        <a href="#" class="btn-primary inline-block">INICIAR TREINO DE PEITO</a>
      </div>
    </div>
  </section>
  ...
  <section class="py-16 px-6 md:px-16 bg-gray-50">
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php
            // Consultar apenas os planos de treino relacionados com peito/peitoral
            ...
            if ($check_tabela->num_rows > 0) {
                // Se existir a tabela de relacionamento, usar JOIN com filtro para peito
                $sql = "SELECT pt.ID_Treino, pt.Nome_Treino, pt.Imagem_Treino,
                        ...
                        WHERE m.Nome_Musculo LIKE '%peito%' OR m.Nome_Musculo LIKE '%peitoral%' 
                           OR m.Nome_Musculo LIKE '%chest%' OR m.Nome_Musculo LIKE '%tórax%'
                           OR pt.Nome_Treino LIKE '%peito%' OR pt.Nome_Treino LIKE '%peitoral%'
                           OR pt.Nome_Treino LIKE '%chest%' OR pt.Nome_Treino LIKE '%tórax%'
                ...
                $sql = "SELECT ID_Treino, Nome_Treino, Imagem_Treino, Musculos_Alvos 
                        FROM Planos_Treino 
                        WHERE Nome_Treino LIKE '%peito%' OR Nome_Treino LIKE '%peitoral%'
                           OR Nome_Treino LIKE '%chest%' OR Nome_Treino LIKE '%tórax%'
                           OR Musculos_Alvos LIKE '%peito%' OR Musculos_Alvos LIKE '%peitoral%'
                           OR Musculos_Alvos LIKE '%chest%' OR Musculos_Alvos LIKE '%tórax%'
            ...
            <?php else: ?>
                <div class="col-span-full">
                    <div class="bg-blue-50 border border-blue-200 text-blue-800 p-6 rounded-lg text-center">
                        ...
                        <p class="text-lg">Nenhum plano de treino de peito registado ainda.</p>
                    </div>
                </div>
            <?php endif; ?>
        </div>
  ...
  <section class="py-16 px-6 gradient-bg text-white text-center">
    <div class="container mx-auto">
      <h2 class="text-4xl font-bold mb-6 header-font">CONSTRUA UM <span class="text-orange-500">PEITO</span> FORTE</h2>
      <p class="text-xl mb-8 max-w-2xl mx-auto">Descubra os nossos planos de treino personalizados para peito e obtenha resultados mais rapidamente</p>
    </div>
  </section>
</main>
