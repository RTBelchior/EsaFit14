...
$page_title = "EsaFit 24 - Treino de Glúteos";

// Definir estilos adicionais específicos desta página
$additional_styles = '
   /* Estilos específicos para a página glúteos */
   .muscle-card {
     border-radius: 1rem;
     overflow: hidden;
...
<main>
  ...
  <section class="relative h-[40vh] overflow-hidden" style="background: url('/api/placeholder/1600/600') no-repeat center center; background-size: cover;">
     ...
     <div class="absolute inset-0 flex flex-col justify-center items-start p-6 md:p-16 text-white container mx-auto">
      <h1 class="text-5xl md:text-6xl font-bold mb-4 header-font">
       TREINO <span class="text-orange-500">GLÚTEOS</span>
      </h1>
      <p class="text-lg md:text-xl max-w-lg mb-8 text-gray-200">
       Fortaleçe e define os teus glúteos com exercícios específicos para esta região muscular.
      </p>
     </div>
  </section>
  ...
  <section class="py-16 px-6 md:px-16 bg-white">
    <div class="container mx-auto">
      <h2 class="text-4xl font-bold mb-12 text-center header-font">GRUPOS <span class="text-orange-500">MUSCULARES</span> DOS GLÚTEOS</h2>
      
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        <!-- Músculo 1 -->
        <div class="muscle-card bg-white border border-gray-100 flex flex-col">
          <div class="h-48 overflow-hidden">
            <img src="https://www.kenhub.com/thumbor/AFFdh5RcqpHVWTbXG7Js9C3G3kw=/fit-in/413x413/filters:fill(FFFFFF,true):watermark(/images/watermark_only_413.png,0,0,0):watermark(/images/logo_url_sm.png,-10,-10,0):format(jpeg)/images/anatomy_term/musculus-gluteus-maximus/UMpPDGJINr1wukpLidakYg_w7ss9tWRW1_M._gluteus_max._NN_1.png" alt="Glúteo máximo" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110"/>
          </div>
          <div class="p-5">
            <h3 class="text-xl font-bold mb-2 header-font text-gray-800">GLÚTEO MÁXIMO</h3>
            <p class="text-gray-600 text-base">O maior músculo glúteo, responsável pela potência e força nos movimentos de extensão do quadril.</p>
          </div>
        </div>
        ...
        <div class="muscle-card bg-white border border-gray-100 flex flex-col">
          <div class="h-48 overflow-hidden">
            <img src="https://www.kenhub.com/thumbor/h_MfUN9e7aKafs5lXFkfj9YzGGc=/fit-in/800x1600/filters:watermark(/images/logo_url.png,-10,-10,0):background_color(FFFFFF):format(jpeg)/images/library/14582/dVGD75SFpFlpRbOM7CNZg_os6gu86kRw_M._gluteus_med._NN_2.png" alt="Glúteo médio" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110"/>
          </div>
          <div class="p-5">
            <h3 class="text-xl font-bold mb-2 header-font text-gray-800">GLÚTEO MÉDIO</h3>
            <p class="text-gray-600 text-base">Responsável pela abdução do quadril e estabilização da pelve durante caminhada e corrida.</p>
          </div>
        </div>
        ...
        <div class="muscle-card bg-white border border-gray-100 flex flex-col">
          <div class="h-48 overflow-hidden">
            <img src="https://www.kenhub.com/thumbor/PBWSNqGqvi5D18f0z0e3cWRNEao=/fit-in/413x413/filters:fill(FFFFFF,true):watermark(/images/watermark_only_413.png,0,0,0):watermark(/images/logo_url_sm.png,-10,-10,0):format(jpeg)/images/anatomy_term/gluteal-surface-of-ilium-1/kWxip8RTQwg2aMsgZhQhQ_4Gluteal_surface_of_ilium.png" alt="Glúteo mínimo" class="w-full h-full object-cover transition-transform duration-700 hover:scale-110"/>
          </div>
          <div class="p-5">
            <h3 class="text-xl font-bold mb-2 header-font text-gray-800">GLÚTEO MÍNIMO</h3>
            <p class="text-gray-600 text-base">Trabalha em conjunto com o glúteo médio para estabilizar a pelve e auxiliar na abdução do quadril.</p>
          </div>
        </div>
      </div>

      <div class="text-center mt-16">
        <a href="#" class="btn-primary inline-block">INICIAR TREINO GLÚTEOS</a>
      </div>
    </div>
  </section>
  ...
  <section class="py-16 px-6 md:px-16 bg-gray-50">
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php
            // Consultar apenas os planos de treino relacionados com glúteos
            ...
            if ($check_tabela->num_rows > 0) {
                // Se existir a tabela de relacionamento, usar JOIN com filtro para glúteos
                $sql = "SELECT pt.ID_Treino, pt.Nome_Treino, pt.Imagem_Treino,
                        ...
                        WHERE m.Nome_Musculo LIKE '%glúte%' OR m.Nome_Musculo LIKE '%gluteo%' 
                           OR m.Nome_Musculo LIKE '%bumbum%' OR m.Nome_Musculo LIKE '%nadega%'
                           OR pt.Nome_Treino LIKE '%glúte%' OR pt.Nome_Treino LIKE '%gluteo%'
                ...
                $sql = "SELECT ID_Treino, Nome_Treino, Imagem_Treino, Musculos_Alvos 
                        FROM Planos_Treino 
                        WHERE Nome_Treino LIKE '%glúte%' OR Nome_Treino LIKE '%gluteo%'
                           OR Nome_Treino LIKE '%bumbum%' OR Nome_Treino LIKE '%nadega%'
                           OR Musculos_Alvos LIKE '%glúte%' OR Musculos_Alvos LIKE '%gluteo%'
                           OR Musculos_Alvos LIKE '%bumbum%' OR Musculos_Alvos LIKE '%nadega%'
            ...
            <?php else: ?>
                <div class="col-span-full">
                    <div class="bg-blue-50 border border-blue-200 text-blue-800 p-6 rounded-lg text-center">
                        ...
                        <p class="text-lg">Nenhum plano de treino para glúteos registado ainda.</p>
                    </div>
                </div>
            <?php endif; ?>
        </div>
  ...
  <section class="py-16 px-6 gradient-bg text-white text-center">
    <div class="container mx-auto">
      <h2 class="text-4xl font-bold mb-6 header-font">CONSTRUA <span class="text-orange-500">GLÚTEOS</span> FORTES</h2>
      <p class="text-xl mb-8 max-w-2xl mx-auto">Descubra os nossos planos de treino personalizados para glúteos e obtenha resultados mais rapidamente</p>
    </div>
  </section>
</main>
